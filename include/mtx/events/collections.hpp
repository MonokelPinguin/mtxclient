...
using RoomAccountDataEvents = boost::variant2::variant<events::Event<account_data::Tag>>;

//! Collection of @p StateEvent only.
using StateEvents = boost::variant2::variant<events::StateEvent<states::Aliases>,
...
using StrippedEvents = boost::variant2::variant<events::StrippedEvent<states::Aliases>,
...
using TimelineEvents = boost::variant2::variant<events::StateEvent<states::Aliases>,
                                                events::StateEvent<states::Avatar>,
                                                events::StateEvent<states::CanonicalAlias>,
                                                events::StateEvent<states::Create>,
                                                events::StateEvent<states::Encryption>,
